  ...
  return (
    <div className="search-bar">
      <label className="field-label">
        <span className="icon icon-search" aria-label="Search tasks" />
        <input className="field" type="text" placeholder="Search tasks" onChange={handleChange} onKeyPress={handleKeyPress} />
      </label>
    </div>
